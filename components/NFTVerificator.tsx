      ...
      <div>
        ...
        <div className="w-full min-h-screen text-slate-300 font-sans font-semibold">
          {this.state.isLoadingNFT ? 
            <div className="w-full flex items-center justify-center"><div className="animate-spin"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          :
            ...
            :
              <div className="flex items-center">Couldn`&apos fetch the NFT </div>
          }
        </div>
      </div>
    );
